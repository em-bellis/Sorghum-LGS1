...
gwas_gemma <- read.table('/Users/emilywork/Desktop/LGS1/MSfigs/global_200_0.01.assoc.txt', header=T) #kinship matrix maf 0.01; snps 0.01; this file was made for global set, setting prob of occurrence outside of 200 km to 0; 10.30.18

##combine gemma output with allele counts
counts <- read.table('/Users/emilywork/Desktop/LGS1/MSfigs/lines.geo.frq.count', header=T, row.names=NULL)
...
qtl <- read.csv('/Users/emilywork/Desktop/LGS1/MSfigs/OZ_Sorghum.csv', head=T)
...
don.sl <- NULL
sl <- read.csv('/Users/emilywork/Desktop/SL_genes.csv', header=T)
